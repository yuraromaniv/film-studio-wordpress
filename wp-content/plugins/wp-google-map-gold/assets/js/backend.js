jQuery(document).ready(function($) {
    ...
    $('span.delete a').click(function() {
        ...
        if (confirm(wpgmp_js_lang.confirm))
            return true;
    ...
    $("div.wpgmp_form_horizontal .wpgmp_add_more_fields").click(function() {

        var wpgmp_length = $(".form-group").length + 1;

        var more_textbox = $('<div class="row form-group">' +
            '<div class="col-md-8"><input  placeholder="Enter name here..." class="form-control" type="text" name="name[]" id="txtbox' + wpgmp_length + '" /></div>' +
            '<div class="col-md-2"><a href="javascript:void(0);" class="btn btn-danger btn-xs wpgmp_remove_more_fields">Remove</a>' +
            '</div></div>');
    ...
    $('div.wpgmp_form_horizontal').on('click', '.wpgmp_remove_more_fields', function() {
    ...
    $('.choose_image').click(function() {
        ...
        wpgmp_image_id = $(this).parent().parent().attr('id', target);
    ...
    window.attach_image = function(html) {
        ...
        $(wpgmp_image_id).find('.remove_image').show();
        $(wpgmp_image_id).find('img.selected_image').attr('src', imgurl);
        var img_hidden_field = $(wpgmp_image_id).find('.choose_image').data('target');
        $(wpgmp_image_id).find('input[name="' + img_hidden_field + '"]').val(imgurl);
        try {
            tb_remove();
        } catch (e) {};
        $('#temp_image').remove();
    ...
    $('.remove_image').click(function() {
        wpgmp_image_id = $(this).parent().parent();
        $(wpgmp_image_id).find('.selected_image').attr('src', '');
        $(wpgmp_image_id).find('input[name="' + $(this).data('target') + '"]').val('');
        $(this).hide();
        return false;
    });

    $(".wpgmp_check_backup").click(function() {
        var wpgmp_bid = confirm("Overwrite existing google maps database?.");
        if (wpgmp_bid == true) {
