...
if ( ! class_exists( 'Flippercode_Product_Overview' ) ) {
	...
	class Flippercode_Product_Overview {
		...
		function __construct($pluginInfo) {
			...
			$this->commonBlocks = array( 'product-activation','newsletter','suggestion-area','socialmedia','refund-block','extended-support' );
			...
			<div class="container">
		        <div class="row product_header">
		            ...
		            <div class="col-md-8 col-sm-8 col-xs-8 product_header_desc">
		                ...
		                <div class="product_desc">Congratulations on purchasing <?php echo $this->productTagLine; ?>, one of our premium product. With this purchase you will get instant support and assistance from our technical support team. Thank you for showing your trust in us.</div>  
		            </div>
		...
		function get_product_slider() {
			// echo '<pre>'; print_r($this->allProductsInfo);
			ob_start();
			?> </div>
					<div class="">
							<div class="product-gallery">
							<p class="col-md-offset-3">Check out our other feature rich wordpress products crafted with technical expertise and patience.
		...
		function setup_plugin_info($pluginInfo) {
			...
			//delete_option($this->productSlug.'_user_has_license');
			...
			$googlemap = array( 'text-domain' => 'wp-google-map-gold','img' => '1.png','url' => 'http://codecanyon.net/item/advanced-google-maps-plugin-for-wordpress/5211638' );
			$gmap_cf7 = array( 'text-domain' => 'cf7-google-maps','img' => '2.png','url' => 'http://codecanyon.net/item/google-maps-integration-using-contact-form-7/9689105' );
			$custom_css_js = array( 'text-domain' => '','img' => '3.png','url' => '' );
			$layers_advance_gmap = array( 'text-domain' => '','img' => '4.png','url' => 'http://codecanyon.net/item/layers-advanced-google-maps/11109123' );
			...
			$overlaypro = array( 'text-domain' => 'op_lang','img' => '6.png','url' => 'http://codecanyon.net/item/overlays-over-images-wordpress-plugin/8520201' );
			$was_this_helpful = array( 'text-domain' => 'was-this-helpful-pro','img' => '7.png','url' => 'http://codecanyon.net/item/was-this-helpful/7415852' );
			$word_highlighter = array( 'text-domain' => '','img' => '8.png','url' => '' );
			$wp_custom_emails = array( 'text-domain' => 'wp-custom-emails','img' => '9.png','url' => 'http://codecanyon.net/item/wordpress-custom-emails/5836005' );
			$display_files = array( 'text-domain' => 'wp-display-files','img' => '10.png','url' => 'http://codecanyon.net/item/display-files-from-directory-dropbox-box-and-amazon-s3/11424356' );
			$wp_newsletter_pro = array( 'text-domain' => '','img' => '11.png','url' => '' );
			$wppostspro = array( 'text-domain' => 'wp-posts-pro','img' => '12.png','url' => 'http://codecanyon.net/item/wordpress-posts-listing-plugin/7292195' );
			$wpsecurityquestion = array( 'text-domain' => 'wp-security-questions-pro','img' => '13.png','url' => 'http://codecanyon.net/item/wordpress-security-questions/5894819' );
			$useravatar = array( 'text-domain' => 'wp-user-avatar-pro','img' => '14.png','url' => 'http://codecanyon.net/item/wp-user-avatar-pro/15638832' );
			...
			$storeLocator = array( 'text-domain' => 'wc-store-locator-pro','img' => '17.png','url' => 'http://codecanyon.net/item/wordpress-store-locator/15672329' );
			/*
			...
			foreach ( $this->commonBlocks as $block ) {
				...
				switch ( $block ) {
				    case 'product-activation':
						...
						$width = 'width:55%';
						$this->blockHeading = '<div class="product-activation-area"><h1 style="'.$width.'">Product Information</h1>';
				    ...
				    case 'product-support':
				      ...
				      <div class="row brow"> 
	                       	...
	                       	<div class="col-md-10"><strong>Online Documentation</strong><br>For our each product we have very well explained starting guide to get you started in matter of minutes.<br><strong><a class="blue" href="'.$this->docURL.'" target="_blank"> Click Here</a></strong>
	                         </div>
                        </div>
                        <div class="row brow"> 
	                       	<div class="col-md-2"><i class="fa fa-file-video-o" aria-hidden="true"></i></div>
