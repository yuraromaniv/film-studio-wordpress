...
$form->add_element( 'checkbox', 'location_settings[hide_infowindow]', array(
	'lable' => __( 'Disable Infowindow', WPGMP_TEXT_DOMAIN ),
	'value' => 'false',
	'id' => 'location_settings',
	'current' => $data['location_settings']['hide_infowindow'],
	'desc' => __( 'Do you want to disable infowindow for this location?', WPGMP_TEXT_DOMAIN ),
	'class' => 'chkbox_class',
));
...
if ( isset( $extra_data['location_extrafields'] ) ) {
	if(!empty($extra_data['location_extrafields'])) {
		...
		$form->add_element( 'text', 'location_extrafields['.$field_name.']', array(
			'lable' => (isset( $label) and ! empty( $label )) ? $label : '',
			...
			'placeholder' => __( 'Field Value', WPGMP_TEXT_DOMAIN ),
			'before' => '<div class="col-md-4">',
			'after' => '</div>',
		));
	...
	$form->add_element( 'message', 'extra_fields_instruction', array(
	'value' => __( 'No extra fields found. You can add extra fields from settings page.',WPGMP_TEXT_DOMAIN ),
