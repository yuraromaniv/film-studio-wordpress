		...
		<div class="col-md-10 col-md-push-1" style="padding:0;background-size: cover;background-position: center;background-image: url(<?=get_the_post_thumbnail_url($post_id, 'large')?>);">
			<div class="single-post-container-single">
				<div class="single-post-content">
					...
					<p class="post-sub-title-single"><?=html_entity_decode(get_field('sub_title', $post_id));?></p>
				</div>
			</div>
		</div>
		<div class="col-md-10 col-md-push-1 post-content-single"><div><span class="text-left date-cont"><?=get_the_time('Y-m-d', $post_id);?></span>
			<span class="text-left show-cont"> <?=getPostViews($post_id);?> view</span></div>
